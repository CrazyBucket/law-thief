...
const GEM_EFFECT_LEVEL_VALUE_TYPES := {
	...
	"followup_ratio": "number", "flush_count": "number", "flush_all_one_status": "bool", "trigger_limit": "number",
...
const GEM_EFFECT_LEVEL_FIELDS := {
	...
	"red:echo": ["echo_tag_count", "followup_ratio"], "red:tide": ["flush_count", "flush_all_one_status"],
	"blue:explosion": ["detonate_on_any_damage", "detonate_on_burning", "detonate_on_explosion", "blast_pattern", "damage_ratio"],
	"blue:poison": ["turn_end_spread", "copy_debuff_on_contact", "copy_debuff_on_damaged", "contact_poison_stacks", "contact_poison_duration", "turn_end_poison_stacks", "turn_end_poison_duration"],
	"blue:fire": ["create_fire_on_contact", "double_burning_on_already_burning", "contact_burning_stacks"],
	"blue:gravity": ["deflect_chance", "redirect_enemy_only", "redirect_radius", "slow_on_damaged", "root_on_damaged"], "blue:impact": ["knockback_steps"],
	...
	"blue:echo": ["echo_tag_count", "first_tag_strength"], "blue:tide": ["trigger_limit", "flush_count", "flush_all_one_status"],
	...
	"black:echo": ["echo_tag_count", "first_tag_repeat_count"], "black:tide": ["death_radius", "flush_count", "flush_all_one_status"],
}
...
const GEM_EFFECT_LEVEL_INTEGER_NON_NEGATIVE_FIELDS := {
	...
	"mark_duration": true, "flush_count": true, "trigger_limit": true,
