...
func _run_tests() -> void:
	...
	assert(is_equal_approx(economy_service.get_amount_ref("rest_site_heal_flat"), 12.0), "flat rest amount ref should resolve configured value")
	var rest_flat_def: Dictionary = economy_service.get_amount_ref_def("rest_site_heal_flat")
	assert(str(rest_flat_def.get("kind", "")) == "flat" and str(rest_flat_def.get("unit", "")) == "hp", "flat rest amount ref should expose hp metadata")
