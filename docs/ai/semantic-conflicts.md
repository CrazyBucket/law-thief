...
- `Technical_Architecture.md` 的旧状态示例则写中毒在回合开始造成伤害。
- `Prototype_MVP.md` 提到"中毒在回合开始掉血"。
...
- `gem_defs.json` 还为爆炸分配了 `blue_turn_start` 能力槽位，运行时在持有者回合开始时对第一个相邻敌人造成 `turn_start_damage` 点伤害。
